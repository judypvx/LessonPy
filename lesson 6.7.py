...
# Подставляя переменную такого цикла в формулу, вы на каждой итерации будете получать один элемент последовательности,
# останется лишь добавить их суммирование.
